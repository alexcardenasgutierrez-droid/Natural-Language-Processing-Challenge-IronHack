...
## Project Description:   
A Natural Language Processing (NLP) project aimed at classifying news headlines as either real or fake news using text vectorization and machine learning classifiers.
